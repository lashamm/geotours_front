...
export class TourService {
  ...
  private i18n: Record<number, Partial<Record<LangCode, TourStrings>>> = {
    ...
    3: {
      geo: { title: 'ძველი თბილისი', region: 'თბილისი', tag: 'კულტურა', shortDescription: 'შეისწავლეთ თბილისის ძველი ქალაქი — გოგირდის აბანოები, ძველი ეკლესიები და ლამაზი ხედები.', highlights: ['ნარიყალის ციხის გათენება', 'აბანოთუბანი გოგირდის აბანოები', 'სასტუმრო ღვინის სადილი', 'ვერნისაჟის ხელოსნური ბაზარი'] },
      ru: { title: 'Старый Тбилиси', region: 'Тбилиси', tag: 'Культура', shortDescription: 'Исследуйте старый город Тбилиси — серные бани, старые церкви и красивые виды с крыш.', highlights: ['Рассвет у крепости Нарикала', 'Серные бани Абанотубани', 'Ужин в духе средневековья', 'Рынок ремёсел Вернисаж'] },
      ar: { title: 'تبليسي القديمة', region: 'تبليسي', tag: 'ثقافة', shortDescription: 'استكشف المدينة القديمة في تبليسي — الحمامات الكبريتية والكنائس القديمة والمناظر الجميلة.', highlights: ['شروق الشمس من قلعة ناريكالا', 'حمامات أبانوتوباني الكبريتية', 'عشاء في نمط الكاروانسراي', 'سوق فيرنيساج للحرف اليدوية'] },
      es: { title: 'Tiflis Antiguo', region: 'Tiflis', tag: 'Cultura', shortDescription: 'Explora el casco antiguo de Tiflis — baños de azufre, iglesias antiguas y hermosas vistas desde las azoteas.', highlights: ['Amanecer en la fortaleza Narikala', 'Baños de azufre Abanotubani', 'Cena en la caravanserai', 'Mercado artesanal Vernissage'] },
      fr: { title: 'Vieux Tbilissi', region: 'Tbilissi', tag: 'Culture', shortDescription: 'Explorez la vieille ville de Tbilissi — bains de soufre, vieilles églises et belles vues sur les toits.', highlights: ['Lever de soleil sur la forteresse Nariqala', "Bains de soufre d'Abanotubani", 'Dîner dans un caravansérail', 'Marché artisanal Vernissage'] },
      it: { title: 'Vecchia Tbilisi', region: 'Tbilisi', tag: 'Cultura', shortDescription: 'Esplora il centro storico di Tbilisi — bagni di zolfo, chiese antiche e belle viste panoramiche.', highlights: ['Alba alla fortezza Narikala', 'Bagni di zolfo di Abanotubani', 'Cena in stile caravanserraglio', 'Mercato artigianale Vernissage'] },
      de: { title: 'Altes Tiflis', region: 'Tiflis', tag: 'Kultur', shortDescription: 'Entdecken Sie die Altstadt von Tiflis — Schwefelbäder, alte Kirchen und schöne Aussichten von den Dächern.', highlights: ['Sonnenaufgang an der Festung Narikala', 'Abanotubani-Schwefelbäder', 'Abendessen im Karawanserei-Stil', 'Vernissage-Kunsthandwerksmarkt'] },
      zh: { title: '老第比利斯', region: '第比利斯', tag: '文化', shortDescription: '探索第比利斯老城区 — 硫磺浴、古老教堂和美丽的屋顶景色。', highlights: ['纳里卡拉要塞日出', '阿巴诺图巴尼硫磺浴', '商队旅馆风格晚宴', '维尔尼萨日手工艺品市场'] },
      tr: { title: 'Eski Tiflis', region: 'Tiflis', tag: 'Kültür', shortDescription: 'Tiflis\'in eski şehrini keşfedin — kükürt hamamları, eski kiliseler ve güzel çatı manzaraları.', highlights: ["Narikala Kalesi'nde gün doğumu", 'Abanotubani kükürt hamamları', 'Kervansaray akşam yemeği', 'Vernissage el sanatları pazarı'] },
    },
    4: {
  ...
  private tours: Tour[] = [
    ...
    },
    {
      ...
      tag: 'Culture',
      shortDescription: 'Explore the historic old town of Tbilisi — sulfur baths, old churches, and beautiful rooftop views.',
